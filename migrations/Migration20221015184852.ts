...
export class Migration20221015184852 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `personal_chat_users_pivot` (`personal_chat_id` varchar(255) not null, `user_id` varchar(255) not null, `last_read_message_id` varchar(255) not null, `mute` tinyint(1) not null, primary key (`personal_chat_id`, `user_id`)) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `text_channel_user_pivot` (`text_channel_id` varchar(255) not null, `user_id` varchar(255) not null, `last_read_message_id` varchar(255) not null, `mute` tinyint(1) not null, primary key (`text_channel_id`, `user_id`)) default character set utf8mb4 engine = InnoDB;');
    this.addSql('alter table `text_channel_user_pivot` add index `text_channel_user_pivot_text_channel_id_index`(`text_channel_id`);');
    this.addSql('alter table `text_channel_user_pivot` add index `text_channel_user_pivot_user_id_index`(`user_id`);');
    this.addSql('alter table `text_channel_user_pivot` add index `text_channel_user_pivot_last_read_message_id_index`(`last_read_message_id`);');
    ...
    this.addSql('alter table `personal_chat_users_pivot` add constraint `personal_chat_users_pivot_personal_chat_id_foreign` foreign key (`personal_chat_id`) references `personal_chat` (`id`) on update cascade;');
    this.addSql('alter table `personal_chat_users_pivot` add constraint `personal_chat_users_pivot_user_id_foreign` foreign key (`user_id`) references `user` (`id`) on update cascade;');
    this.addSql('alter table `personal_chat_users_pivot` add constraint `personal_chat_users_pivot_last_read_message_id_foreign` foreign key (`last_read_message_id`) references `personal_message` (`id`) on update cascade;');
    ...
    this.addSql('alter table `text_channel_user_pivot` add constraint `text_channel_user_pivot_text_channel_id_foreign` foreign key (`text_channel_id`) references `text_channel` (`id`) on update cascade;');
    this.addSql('alter table `text_channel_user_pivot` add constraint `text_channel_user_pivot_user_id_foreign` foreign key (`user_id`) references `user` (`id`) on update cascade;');
    this.addSql('alter table `text_channel_user_pivot` add constraint `text_channel_user_pivot_last_read_message_id_foreign` foreign key (`last_read_message_id`) references `text_channel_message` (`id`) on update cascade;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table `group_invite` drop foreign key `group_invite_group_id_foreign`;');
    ...
    this.addSql('alter table `text_channel_user_pivot` drop foreign key `text_channel_user_pivot_text_channel_id_foreign`;');
    ...
    this.addSql('alter table `group_invite` drop foreign key `group_invite_from_user_id_foreign`;');

    this.addSql('alter table `group_invite` drop foreign key `group_invite_to_user_id_foreign`;');
    ...
    this.addSql('alter table `text_channel_user_pivot` drop foreign key `text_channel_user_pivot_user_id_foreign`;');
    ...
    this.addSql('drop table if exists `text_channel_user_pivot`;');

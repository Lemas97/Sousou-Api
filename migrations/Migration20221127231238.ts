...
export class Migration20221127231238 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `personal_chat_users_pivot` (`id` varchar(255) not null, `last_read_message_id` varchar(255) null, `mute` tinyint(1) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `personal_chat` (`id` varchar(255) not null, `pivot_id` varchar(255) null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `personal_chat_users_pivot_users` (`personal_chat_users_pivot_id` varchar(255) not null, `user_id` varchar(255) not null, primary key (`personal_chat_users_pivot_id`, `user_id`)) default character set utf8mb4 engine = InnoDB;');

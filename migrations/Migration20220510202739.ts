...
export class Migration20220510202739 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `user` (`id` varchar(255) not null, `username` varchar(255) not null, `display_name` varchar(255) not null, `email` varchar(255) not null, `code` varchar(255) not null, `password` varchar(255) not null, `icon` varchar(255) not null, `created_at` datetime not null, `confirm_email_token` varchar(255) not null, `email_confirm` tinyint(1) not null, `preferences` json not null, `connected_voice_channel_id` varchar(255) null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
